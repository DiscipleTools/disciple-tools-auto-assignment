...
/**
 * Class Disciple_Tools_Auto_Assignment_Settings_Tile
 *
...
class Disciple_Tools_Auto_Assignment_Settings_Tile
{
    ...
    public function dt_profile_settings_page_menu( $dt_user, $dt_user_meta, $dt_user_contact_id, $contact_fields ) {
        ?>
        <li><a href="#disciple_tools_auto_assignment_settings_id"><?php esc_html_e( 'Custom Settings Section', 'disciple-tools-auto-assignment' )?></a></li>
        <?php
    }
    ...
    public function dt_profile_settings_page_sections( $dt_user, $dt_user_meta, $dt_user_contact_id, $contact_fields ) {
        ?>
        <div class="cell bordered-box" id="disciple_tools_auto_assignment_settings_id" data-magellan-target="disciple_tools_auto_assignment_settings_id">
            <button class="help-button float-right" data-section="disciple-tools-auto-assignment-help-text">
                <img class="help-icon" src="<?php echo esc_html( get_template_directory_uri() . '/dt-assets/images/help.svg' ) ?>"/>
            </button>
            <span class="section-header"><?php esc_html_e( 'Custom Settings Section', 'disciple-tools-auto-assignment' )?></span>
            <hr/>
    ...
    public function dt_modal_help_text(){
        ?>
        <div class="help-section" id="disciple-tools-auto-assignment-help-text" style="display: none">
            <h3><?php echo esc_html_x( "Custom Settings Section", 'Optional Documentation', 'disciple-tools-auto-assignment' ) ?></h3>
            <p><?php echo esc_html_x( "Add your own help information into this modal.", 'Optional Documentation', 'disciple-tools-auto-assignment' ) ?></p>
        </div>
        <?php
    }
}

Disciple_Tools_Auto_Assignment_Settings_Tile::instance();
