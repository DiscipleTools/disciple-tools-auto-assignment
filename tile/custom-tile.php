...
class Disciple_Tools_Auto_Assignment_Tile
{
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === "contacts" || $post_type === "auto_assign_post_type" ){
            $tiles["disciple_tools_auto_assignment"] = [ "label" => __( "Auto Assignment", 'disciple-tools-auto-assignment' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" || $post_type === "auto_assign_post_type" ){
             ...
             */
            $fields['disciple_tools_auto_assignment_text'] = [
                'name'        => __( 'Text', 'disciple-tools-auto-assignment' ),
                'description' => _x( 'Text', 'Optional Documentation', 'disciple-tools-auto-assignment' ),
                'type'        => 'text',
                'default'     => '',
                'tile' => 'disciple_tools_auto_assignment',
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ];
            /**
             * This is an example of a multiselect field
             */
            $fields["disciple_tools_auto_assignment_multiselect"] = [
                "name" => __( 'Multiselect', 'disciple-tools-auto-assignment' ),
                "default" => [
                    "one" => [ "label" => __( "One", 'disciple-tools-auto-assignment' ) ],
                    "two" => [ "label" => __( "Two", 'disciple-tools-auto-assignment' ) ],
                    "three" => [ "label" => __( "Three", 'disciple-tools-auto-assignment' ) ],
                    "four" => [ "label" => __( "Four", 'disciple-tools-auto-assignment' ) ],
                ],
                "tile" => "disciple_tools_auto_assignment",
                "type" => "multi_select",
                "hidden" => false,
             ...
             */
            $fields["disciple_tools_auto_assignment_keyselect"] = [
                'name' => "Key Select",
                'type' => 'key_select',
                "tile" => "disciple_tools_auto_assignment",
                'default' => [
                    'first'   => [
                        "label" => _x( 'First', 'Key Select Label', 'disciple-tools-auto-assignment' ),
                        "description" => _x( "First Key Description", "Training Status field description", 'disciple-tools-auto-assignment' ),
                        'color' => "#ff9800"
                    ],
                    'second'   => [
                        "label" => _x( 'Second', 'Key Select Label', 'disciple-tools-auto-assignment' ),
                        "description" => _x( "Second Key Description", "Training Status field description", 'disciple-tools-auto-assignment' ),
                        'color' => "#4CAF50"
                    ],
                    'third'   => [
                        "label" => _x( 'Third', 'Key Select Label', 'disciple-tools-auto-assignment' ),
                        "description" => _x( "Third Key Description", "Training Status field description", 'disciple-tools-auto-assignment' ),
                        'color' => "#366184"
                    ],
                ],
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === "contacts" || $post_type === "auto_assign_post_type" ) && $section === "disciple_tools_auto_assignment" ){
            /**
...
Disciple_Tools_Auto_Assignment_Tile::instance();
