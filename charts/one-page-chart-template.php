...
class Disciple_Tools_Auto_Assignment_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-auto-assignment-metrics'; // lowercase
    public $base_title = "Auto Assignment Metrics";
    ...
    public function scripts() {
        ...
        wp_localize_script(
            'dt_'.$this->slug.'_script', $this->js_object_name, [
                ...
                'translations' => [
                    "title" => $this->title,
                    "Sample API Call" => __( "Sample API Call", 'disciple-tools-auto-assignment' )
                ]
            ]
        );
    }
