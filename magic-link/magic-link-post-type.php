...
/**
 * Class Disciple_Tools_Auto_Assignment_Magic_Link
 */
class Disciple_Tools_Auto_Assignment_Magic_Link extends DT_Magic_Url_Base {
    ...
    public $post_type = 'auto_assign_post_type'; // @todo set the post type this magic link connects with.
    private $meta_key = '';
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === $this->post_type ){
            $tiles["dt_starters_magic_url"] = [
                "label" => __( "Magic Url", 'disciple-tools-auto-assignment' ),
    ...
    public function footer_javascript(){
        ...
        <script>
            ...
            let jsObject = [<?php echo json_encode([
                ...
                'parts' => $this->parts,
                'translations' => [
                    'add' => __( 'Add Magic', 'disciple-tools-auto-assignment' ),
                ],
            ]) ?>][0]
...
Disciple_Tools_Auto_Assignment_Magic_Link::instance();
