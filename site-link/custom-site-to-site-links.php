...
class Disciple_Tools_Auto_Assignment_Site_Links {
    public $type = 'disciple_tools_auto_assignment';
    ...
    public function site_link_type( $type ) {
        $type[$this->type] = __( 'Auto Assignment' );
        return $type;
    }
}
Disciple_Tools_Auto_Assignment_Site_Links::instance();
